...
describe('AuthService', () => {
    ...
    it('should hash password and create user', async () => {
        const hashSpy = jest.spyOn(argon, 'hash').mockResolvedValue('hashedPassword');
    ...
    it('should throw error if password is incorrect', async () => {
        ...
        await expect(authService.signin({ email: 'test@example.com', password: 'wrong' }))
            .rejects.toThrow(ForbiddenException);
    });
    ...
    it('should throw error if user does not exist', async () => {
        ...
        await expect(authService.signin({ email: 'notfound@example.com', password: 'password' }))
            .rejects.toThrow(ForbiddenException);
    });
});
