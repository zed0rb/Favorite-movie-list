...
describe('MovieService', () => {
  ...
  describe('addMovie', () => {
    ...
    it('should throw an error if movie already exists', async () => {
      ...
      await expect(
        movieService.addMovie(userId, createMovieDto),
  ...
  describe('deleteMovie', () => {
    ...
    it('should throw NotFoundException if movie does not exist', async () => {
      ...
      await expect(movieService.deleteMovie(1, 99)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('should throw ForbiddenException if user does not own the movie', async () => {
      ...
      await expect(movieService.deleteMovie(1, 1)).rejects.toThrow(
        ForbiddenException,
      );
    });
  });
